...
int main()
{
  ...
  /* printgi(sneg); printf (" x "); printgi(spos); printf (" = "); printgi(vezes(sneg,spos)); printf ("\n"); */
  ...
  printgi(bigneg); printf (" x "); printgi(bigpos); printf (" = "); printgi(vezes(bigneg,bigpos)); printf ("\n");
